...
## Features
- **Real-time calculation:** Get your BMI instantly.
- **Visual indicators:** The app changes color based on BMI categories:
  - 🔵 **Blue**: Underweight (< 18.5)
  - 🟢 **Green**: Normal weight (18.5 - 24.9)
  - 🟡 **Yellow**: Overweight (25 - 29.9)
  - 🔴 **Red**: Obesity (30+)
- **Error Handling:** Validates input to ensure only numbers are entered.
